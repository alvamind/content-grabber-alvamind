...
function publishPackage() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            console.log(chalk_1.default.cyan('📋 Validating package.json...'));
            validatePackageJson();
            console.log(chalk_1.default.green('✅ package.json is valid'));
            // Check current branch
            const currentBranch = getCurrentBranch();
            if (currentBranch !== 'main' && currentBranch !== 'master') {
                console.log(chalk_1.default.yellow(`⚠️  You're on branch '${currentBranch}'.`));
            }
            ...
            try {
                ...
                console.log(chalk_1.default.yellow('⚠️  No tests found or tests failed'));
            }
            // Version increment
